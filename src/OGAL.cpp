...
{
    std::vector<OGAL::buffer_texture_pair2> buff = renderable->return_buffer_texture_pairs();
    ...
    for (OGAL::buffer_texture_pair2 data : buff) {
        ...
        glDrawArrays(GL_TRIANGLES, 0,  data.buffer_size); // Starting from vertex 0; 3 vertices total -> 1 triangle
    }

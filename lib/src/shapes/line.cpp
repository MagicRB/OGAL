...
void OGAL::Line::set_positions(glm::vec<2, float, (glm::qualifier) 0> position1,
                               glm::vec<2, float, (glm::qualifier) 0> position2)
{
...
{
    std::vector<GLfloat> v = {position_.x, position_.y, 0.0f, color_.r, color_.g, color_.b, color_.a, 0.0f, 0.0f, 0.0f,
                              position_.z, position_.w, 0.0f, color_.r, color_.g, color_.b, color_.a, 0.0f, 0.0f, 0.0f
    };
